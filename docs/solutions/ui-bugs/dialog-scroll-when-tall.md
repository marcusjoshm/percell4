...
duplicates_at:
  - {path: "src/percell4/gui/import_dialog.py", note: "wraps content in QScrollArea (lines 45-55) — candidate canonical"}
  - {path: "src/percell4/gui/compress_dialog.py", note: "wraps content in QScrollArea (lines 80-86) — candidate canonical"}
