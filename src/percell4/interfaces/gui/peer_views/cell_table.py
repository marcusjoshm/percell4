...
QSortFilterProxyModel. Row clicks sync to Session selection.
"""
...
class CellTableWindow(QMainWindow):
    ...
    def _apply_filter(self) -> None:
        ...
        try:
            self._proxy.set_filter_labels(self._session.filter_ids)
    ...
    def _export_selection(self) -> None:
        ...
        df = self._session.df
        selected_ids = self._session.selected_ids
